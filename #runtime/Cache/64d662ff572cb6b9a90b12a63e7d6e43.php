		...
		<div class="col-xs-offset-3 col-xs-8">
		  <button type="button" class="btn btn-purp" id="search_btn">查&nbsp;&nbsp;&nbsp;询</button>
            ...
            <div class="panel panelsmall">
                ...
                <ul class="lists">
                	<?php if(is_array($hotcity)): foreach($hotcity as $key=>$vo): ?><li><a class="lists_a" href="/<?php echo ($vo["typedir"]); ?>/"><span class="glyphicon glyphicon-play"></span><?php echo ($vo["typename"]); ?>酒店<span class="pull-right"><?php if(($vo["count"] == null)): ?>0<?php endif; echo ($vo["count"]); ?>家酒店</span></a></li><?php endforeach; endif; ?>
                </ul>
            </div>
        </div>
        ...
        <div class="maps_tab">
			...
			<?php if(is_array($continentlist)): foreach($continentlist as $key=>$v): if(($v["lev"] == 1)): ?><div class="tab-pane <?php if(($key == 0)): ?>active<?php endif; ?>" id="<?php echo ($v["typedir"]); ?>">
              	<ul class="state_country">
					<?php if(is_array($continentlist)): foreach($continentlist as $ks=>$vs): if(($vs["lev"] == 2 and $v['id'] == $vs['reid'])): ?><li><a href="/<?php echo ($vs["typedir"]); ?>/"><?php echo ($vs["typename"]); ?></a></li><?php endif; endforeach; endif; ?>
                </ul>
