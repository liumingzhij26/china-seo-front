...
<div class="container">
	...
	<div class="row">
    	<div class="col-md-8">
            <div class="panel">
            	<div class="head1">
                    <h1>去<?php echo ($data["obj"]["typename"]); ?>旅游攻略2014</h1>
        ...
        <div class="col-md-4 left-clear">
            <div class="panel">
                ...
                <span class="more_right"><a href="__HT__/<?php echo ($data["obj"]["typedir"]); ?>-guide/">更多&gt;&gt;</a></span>
                <ul class="lists">
...
$(function(){
	...
	$('.nav').find('a').click(function(){
		...
		$.post("/<?php echo ($data["obj"]["typedir"]); ?>-guide-list/",{"order":guide_form.val()},function(data){
			if(data == 0){	
				return;
			}else{
				var obj = eval('(' + data + ')');
...
function getPage(order_val,page){
	...
	$.post("/<?php echo ($data["obj"]["typedir"]); ?>-guide-list/",{"order":order_val,"page":page},function(data){
		if(data == 0){	
			return;
		}else{
			var obj = eval('(' + data + ')');
