<?php
	...
	foreach($_city_list as $v){	
		echo $i."<br/>";
		$i++;		
		$_get_data_zh = get_curl($v['typedir'],'zh_CN','CNY');//en_AU  zh_CN
		dump($_get_data_zh);
	}
...
function ex_query($_city_name = '',$_price_type = ''){
	...
	$_get_data_zh = get_curl($_city_name,'zh_CN',$_price_type);//en_AU  zh_CN
