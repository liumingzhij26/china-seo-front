...
<HotelShoppingRequest xmlns="http://ws.orbitz.com/schemas/2008/Hotel">
   <Locale>{$_data['language']}</Locale>
   <PointOfSale>HCL</PointOfSale>
   <LocationKeyword>{$_data['name']}</LocationKeyword>
   <PurchaseCurrency>{$_data['purchase']}</PurchaseCurrency>
   <ShowContent>true</ShowContent>
   <AllowCachedRates>NEVER</AllowCachedRates>
   <OccupantDetails>
      <Adult count="1" />
      <Senior count="0" />
      <Children count="0" />
