...
<div class="container">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="/{$data['position']['typedir']}-guide/">{$data['position']['p_typename']}攻略</a></li>
        <li><a href="/{$data.list.typedir}-guide/">{$data['position']['typename']}攻略</a></li>
		<else/>
		<li><a href="/{$data.list.typedir}-guide/">{$data.list.typename}攻略</a></li>
		</if>
...
<div class="container">
	...
	<div class="row">
    	<div class="col-md-8">
        	<div class="panel">
            	<div class="post_head">
                    ...
                    <div class="namex"><span class="name">{$data.list.writer}</span><span>{$data.list.pubdate|date="Y-m-d H:m:s",###}</span>   <span>浏览：{$data.list.click}</span>   <span>评论：2</span></p></div>
                    <div class="namex namey hidden"><span>标签：<a>蜜月</a> <a>自驾</a></span><span>分类：<a href="/{$data.list.typedir}-guide">{$data.list.typename}</a></span></div>
                </div>
                ...
                <div class="prenext">
                	<span class="pull-left">上一篇：<if condition="($data['pre'] neq null)"><a href="/guide-{$data['pre']['id']}.html">{$data['pre']['title']}</a><else/>没有数据</if></span>
					<span class="pull-right">下一篇：<if condition="($data['next'] neq null)"><a href="/guide-{$data['next']['id']}.html">{$data['next']['title']}</a><else/>没有数据</if></span>
                </div>
            </div>
            	...
            	<div class="head1">
           		...
           		<ul class="lists_post">
					<foreach name="data.headline_pubdate" item="val" key="key">
						<li><a href="/guide-{$val['id']}.html">{$val['title']}</a></li>
					</foreach>      
                </ul>
            </div>
        </div>
        <div class="col-md-4 left-clear">
        	<div class="sidemenu">
            	<ul>
	            	<li class="sl_1"><a <if condition="($data.explain neq '')">href="/guide-{$data.explain.id}.html"</if> class="btn btn-default">{$data.list.typename}概况<i></i></a></li>
                    <li class="sl_2"><a <if condition="($data.scene neq '')">href="/guide-{$data.scene.id}.html"</if> class="btn btn-default">{$data.list.typename}景点<i></i></a></li>
                    <li class="sl_3"><a href="/{$data.list.typedir}-guide-list/" class="btn btn-default">{$data.list.typename}游记<i></i></a></li>
                    <li class="sl_4"><a href="/{$data.list.typedir}/" class="btn btn-default">{$data.list.typename}酒店<i></i></a></li>
            ...
            <div class="panel">
                ...
                <span class="more_right"><a href="/{$data.list.typedir}-guide-list/">更多&gt;&gt;</a></span>
                <ul class="lists">
				<foreach name="data.new_list" item="val" key="key">
                    <if condition="($val['id'] neq $data['list']['id'])">
                	<li><a href="/guide-{$val['id']}.html" class="lists_a"><span class="glyphicon glyphicon-play"></span>{$val['title']}</a></li>
                    </if>
                </foreach>               
                </ul>
            </div>
            <div class="panel">
                ...
                <span class="more_right"><a href="/{$data.list.typedir}/">更多&gt;&gt;</a></span>
