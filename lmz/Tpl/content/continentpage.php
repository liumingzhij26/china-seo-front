    	...
    	<div class="col-xs-4">
            ...
            <div class="panel panelsmall">
                ...
                <ul class="lists">
                	...
                	<li><a class="lists_a" href="/{$vo.typedir}/"><span class="glyphicon glyphicon-play"></span>{$vo.typename}酒店<span class="pull-right"><if condition="($vo.count eq null)">0</if>{$vo.count}家酒店</span></a></li>
                	</foreach>
                </ul>
            </div>
        </div>
                  ...
                  <div class="col-xs-3">
                    <div class="thumbnail">
                      ...
                      <div class="captiontop">
                        <h3><a href="/{$vo.typedir}/">{$vo.typename}</a></h3>
                      </div>
                      <div class="caption">
                        <h3><a href="/{$vo.typedir}/"><if condition="($vo.count eq null)">0<else />{$vo.count}</if>家酒店</a></h3>
                      </div>
                    </div>
                  </div>
                </foreach>              
